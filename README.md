...
|---|---|---|---|---|
| **gemma2-2b** | 0.3740 | 0.3287 | 0.2979 | 0.2836 |
| **llama3.2-3b** | 0.4390 | 0.4475 | 0.4405 | 0.4363 |
| **qwen2.5-3b** | 0.4309 | 0.3600 | 0.3447 | 0.3412 |
...
![Métricas de Avaliação Exata — Comparação entre Modelos](results/oab_exams/charts/rag/01_barras_metricas_exatas.png)
...
![Desempenho Geral dos Modelos — Radar](results/oab_exams/charts/rag/02_radar_metricas_exatas.png)
...
|---|---|---|---|---|---|
| **gemma2:2b vs llama3.2:3b** | 0.1141 | 0.4732 | 0.1914 | 0.2543 | 0.7391 |
| **gemma2:2b vs qwen2.5:3b** | 0.1200 | 0.4933 | 0.1775 | 0.2305 | 0.7430 |
| **gemma2:2b vs guideline** | 0.0239 | 0.1487 | 0.0584 | 0.1048 | 0.6586 |
#### 🔹 Modelo Principal: llama3.2-3b
| Comparação | BLEU | ROUGE-1 | ROUGE-2 | ROUGE-L | BERTScore F1 |
|---|---|---|---|---|---|
| **gemma2:2b vs llama3.2:3b** | 0.1141 | 0.4732 | 0.1914 | 0.2543 | 0.7391 |
| **llama3.2:3b vs qwen2.5:3b** | 0.1126 | 0.4847 | 0.1924 | 0.2431 | 0.7408 |
| **llama3.2:3b vs guideline** | 0.0333 | 0.1810 | 0.0801 | 0.1311 | 0.6695 |
#### 🔹 Modelo Principal: qwen2.5-3b
| Comparação | BLEU | ROUGE-1 | ROUGE-2 | ROUGE-L | BERTScore F1 |
|---|---|---|---|---|---|
| **gemma2:2b vs qwen2.5:3b** | 0.1200 | 0.4933 | 0.1775 | 0.2305 | 0.7430 |
| **llama3.2:3b vs qwen2.5:3b** | 0.1126 | 0.4847 | 0.1924 | 0.2431 | 0.7408 |
| **qwen2.5:3b vs guideline** | 0.0252 | 0.1454 | 0.0632 | 0.1010 | 0.6622 |
...
![Heatmap de Similaridade Semântica](results/oab_bench/charts/rag/01_heatmap_bertscore.png)
...
![Métricas de Similaridade — Comparação entre Modelos](results/oab_bench/charts/rag/02_barras_modelo_vs_modelo.png)
...
![Aderência dos Modelos à Guideline](results/oab_bench/charts/rag/03_barras_modelo_vs_guideline.png)
...
![Perfil de Métricas — Modelo vs Guideline](results/oab_bench/charts/rag/04_radar_modelo_vs_guideline.png)
...
![BERTScore F1 por Turn](results/oab_bench/charts/rag/05_turn1_vs_turn2_bertscore.png)
...
![Score Médio por Modelo — Juiz GPT-4o-mini](results/oab_bench/charts/rag/06_judgment_score_medio.png)
...
![Score por Modelo e Turn — Juiz GPT-4o-mini](results/oab_bench/charts/rag/07_judgment_score_por_turn.png)
...
![Distribuição dos Scores — Boxplot](results/oab_bench/charts/rag/08_judgment_boxplot.png)
...
![Scores por Questão e Modelo](results/oab_bench/charts/rag/09_judgment_heatmap_questoes.png)
...
![Correlação BERTScore vs Nota do Juiz](results/oab_bench/charts/rag/10_correlacao_bertscore_judgment.png)
